    ...
    public static void main(String[] args) {
        ...
        for (int test = 0; test < 1500; test++) {
            ...
            for (int r = 0; r < 4; r++) {
                ...
                if (r < 2) { Map<Integer, BigInteger> opposite = new LinkedHashMap<>(); terms.forEach((i,v) -> opposite.put(i,v.negate())); rows.add(new ExactLinearProgram.Constraint(opposite, rhs.negate())); }
            }
